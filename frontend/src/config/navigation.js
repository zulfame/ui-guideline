        ...
        items: [
          ...
          },
          {
            ...
            children: [
              ...
              { title: "Notification", to: "/push-notifications", icon: BellRing, adminOnly: true },
              { title: "Security", to: "/login-security", icon: ShieldAlert, adminOnly: true },
              { title: "Sessions", to: "/sessions", icon: MonitorSmartphone, adminOnly: true },
...
export const getBreadcrumb = (pathname) => {
  ...
  const subRoutes = [
    ...
    { re: /^\/users\/[^/]+\/edit$/, parent: "/users", title: "Detail User" },
    { re: /^\/roles\/new$/, parent: "/roles", title: "Add Role" },
    { re: /^\/roles\/[^/]+\/edit$/, parent: "/roles", title: "Detail Role" },
