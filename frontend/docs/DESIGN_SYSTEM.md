...
| Update 6 | **Kustomisasi sidebar-07** (styling, tanpa primitive baru): (a) `SidebarSeparator` di bawah header + header `sticky top-0 bg-sidebar`; (b) blok user footer dibuat "timbul" (`bg-sidebar-accent` + border + `shadow-sm`) menyerupai state hover. |
