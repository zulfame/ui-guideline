...
| accordion, alert-dialog, aspect-ratio, calendar, carousel, command, context-menu, dialog, drawer, hover-card, input-otp, menubar, navigation-menu, pagination, popover, progress, radio-group, resizable, select, slider, switch, tabs, textarea, toggle, toggle-group | ⚪ | Tersedia; daftarkan sebagai ✅ saat pertama kali dipakai. |
