...
**8. Card Spacing** — `CardHeader` `p-6 space-y-1.5` + `border-b` (pemisah header↔body); `CardContent` `p-6`; `CardFooter` `p-6` + `border-t` (pemisah body↔footer); antar-kartu di grid `gap-4`. Jangan bungkus padding ganda di dalam Card.
